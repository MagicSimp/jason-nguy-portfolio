      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:block">
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-full px-8 py-3">
          ...
          <div className="hidden md:flex items-center space-x-3">
            <Button
              ...
              variant="outline"
              className="border-purple-400 text-purple-300 hover:bg-purple-500 hover:text-white backdrop-blur-sm"
            >
